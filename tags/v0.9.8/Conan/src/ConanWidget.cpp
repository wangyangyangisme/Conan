...
namespace conan {
    ...
    namespace /*unnamed*/ {
        ...
        */
        ...
        /*!
            ...
            \param[in]  inObject    The object
            \param[out] outList     The list of class info <name, value>
        */
        void BuildClassInfoData (const QObject* inObject, std::vector <std::pair <QString, QString> >& outList) {
            if (!inObject) {
                return;
            }
            const QMetaObject* metaObject = inObject->metaObject ();
            ...
            for (int i=0; i<count; i++)
            {
                ...
                outList [i] = std::make_pair (classInfo.name (), classInfo.value ());
            }
        }
    }
    ...
    */
    struct CONAN_LOCAL ContainsDuplicateConnections : public std::unary_function <const ObjectItem*, bool> {
    ...
    */
    void ConanWidget::InitObjectHierarchyTab () {
        ...
        mForm.objectTree->header ()->setResizeMode (ObjectModel::kAddress, QHeaderView::ResizeToContents);
        ...
        mForm.signalTree->header ()->setResizeMode (ConnectionModel::kAccess, QHeaderView::ResizeToContents);
        ...
        mForm.slotTree->header ()->setResizeMode (ConnectionModel::kAccess, QHeaderView::ResizeToContents);
        ...
        addAction (mForm.actionRemoveRootObject);
    }
    ...
    */
    void ConanWidget::ClearCurrentObjectViews () {
        ...
        mClassInfoModel->SetClassInfo (std::vector <std::pair <QString, QString> > ());
    }
    ...
    */
    ...
    void ConanWidget::SlotRemoveRootObject (){
        ...
        if (const QObject* object = mObjectModel->GetObject (current)) {
            if (QMessageBox::Yes == QMessageBox::question(this, "Remove root object",
    ...
    */
    void ConanWidget::SlotCurrentObjectChanged (const QModelIndex& inCurrent, const QModelIndex& inPrevious) {
        ...
        std::vector <std::pair <QString, QString> > classInfoData;
