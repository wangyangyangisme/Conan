...
namespace conan {
    ...
    */
    struct CONAN_LOCAL MatchObjectByValue : public std::unary_function <const ObjectItem*, bool>
    {
    ...
    */
    struct CONAN_LOCAL ObjectItemSorter : std::binary_function <const ObjectItem*, const ObjectItem*, bool> {
