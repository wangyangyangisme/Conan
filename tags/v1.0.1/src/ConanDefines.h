...
#if QT_VERSION < QT_VERSION_CHECK (4, 6, 0) || QT_VERSION > QT_VERSION_CHECK (4, 7, 1)
#error "Conan currently supports Qt 4.6.0 - 4.7.1; although newer versions may work"
#endif
...
#define CONAN_VERSION_STR "1.0.1"
//! The current version number: (major << 16) + (minor << 8) + patch.
#define CONAN_VERSION 0x010001
