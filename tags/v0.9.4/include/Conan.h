...
#if QT_VERSION < QT_VERSION_CHECK (4, 4, 3) || QT_VERSION > QT_VERSION_CHECK (4, 5, 1)
#error "CONAN currently only supports Qt 4.4.3 and Qt 4.5.1"
#endif
...
/*!
    ...
    \li Find duplicate connections - Scans the entire \a Object \a Hierarchy tree view for the next occurance of a
        ...
        signal/slot. Duplicate connections are marked by a bright yellow background.
