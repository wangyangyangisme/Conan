...
/*!
    ...
    <img src="http://download.famouswhy.com/awards/Famous_Software_Award_Logo.png" alt="Famous Software Award">
...
<export conan="1.0.0" qt="4.7.0" created="2010-10-17T17:52:01">
    ...
    Note that removing a child object is not allowed, as that same child object would reappear after pressing \a Refresh
    from the toolbar.
