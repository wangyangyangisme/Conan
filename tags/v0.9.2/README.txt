Conan 0.9.2 - Connection analyzer for Qt 4.4.3 - Qt 4.5.0
---------------------------------------------------------
    ...
    -Find duplicate signal connections
...
------------
    ...
    sources are located in $(QTDIR)/src. The file ConanWidget_p.h includes the
    following Qt source files:
        $(QTDIR)/src/corelib/kernel/qobject_p.h
        $(QTDIR)/src/corelib/thread/qthread_p.h
