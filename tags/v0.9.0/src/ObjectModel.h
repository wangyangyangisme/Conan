...
namespace conan {
    ...
    */
    ...
    public:
        ...
        const ObjectItem* Find (const QString& inValue, const ObjectItem* inStartItem=0, bool* inMatch=0) const;
        void Sort (const ObjectItemSorter& inPred);
    ...
    protected:
        ...
        std::vector <ObjectItem*> mChildren;
    ...
    */
    class RootItem : public ObjectItem {
    ...
    */
    struct ObjectItemSorter : std::binary_function <const ObjectItem*, const ObjectItem*, bool> {
    ...
    */
    ...
    public:
        ...
        QModelIndex FindObject (const QString& inValue, const QModelIndex& inStart = QModelIndex ()) const;
